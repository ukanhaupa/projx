...
export function renderTemplate<const K extends string>(
  ...
  const missing = template.keys.filter(
...
function renderEmail(
  ...
  return renderTemplate(EMAIL_HTML_TEMPLATE, {
    title,
    message,
    actionLabel,
    actionUrl,
